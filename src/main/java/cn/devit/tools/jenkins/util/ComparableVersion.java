...
public class ComparableVersion implements Comparable<ComparableVersion> {
    ...
    private static class StringItem implements Item {
         ...
         * a lot of
         * if/then/else to check for -1 or QUALIFIERS.size and then resort to
         * lexical
         * ordering. Most comparisons are decided by the first character, so
         * this is still
         * fast. If more characters are needed then it requires a lexical sort
         * anyway.
         *
         * @param qualifier
     ...
     * item list
     * and for sub-lists (which start with '-(number)' in the version
     * specification).
     */
